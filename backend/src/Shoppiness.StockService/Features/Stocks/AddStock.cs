...
public static class AddStock
{
    ...
    {
        private static readonly MovementType[] ValidTypes = [MovementType.Replenishment, MovementType.Return];
    ...
    {
        routes.MapPatch("/stock/{productId:guid}/add", HandleAsync)
            .WithName("AddStock")
            .WithTags("Stock")
            .WithSummary("Add stock quantity for a product (Replenishment or Return)")
